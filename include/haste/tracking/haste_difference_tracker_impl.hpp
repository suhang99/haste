...
auto HasteDifferenceTracker::updateTemplate() -> void { updateTemplateWithMiddleEvent(kWeight_); };
...
auto HasteDifferenceTracker::updateHypothesesScore(const EventTuple &oldest_event,
